...
data PDiscoverySetNodeState (s :: S)
...
mkNode :: Term s (PNodeKey :--> PNodeKey :--> PInteger :--> PDiscoverySetNode)
...
mkBSNode :: ClosedTerm (PByteString :--> PByteString :--> PInteger :--> PAsData PDiscoverySetNode)
...
-}
asPredecessorOf :: ClosedTerm (PAsData PDiscoverySetNode :--> PByteString :--> PInteger :--> PDiscoverySetNode)
...
-}
asSuccessorOf :: ClosedTerm (PByteString :--> PAsData PDiscoverySetNode :--> PInteger :--> PDiscoverySetNode)
